...
function App() {
  return (
    <AuthProvider>
      <div className="min-h-screen min-h-[100dvh] w-full bg-slate-950 flex items-center justify-center p-0 sm:p-8 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-md h-screen h-[100dvh] sm:h-[844px] bg-soft-bg sm:rounded-[40px] sm:shadow-[0_0_0_10px_#1e293b,0_20px_50px_rgba(0,0,0,0.6)] overflow-hidden flex flex-col">
